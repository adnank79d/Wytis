...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-[100dvh]">
      ...
      <section className="w-full pt-12 lg:pt-16 pb-12 md:pb-20 bg-background border-b border-border/40">
          ...
          <div className="flex flex-col items-center text-center gap-10">
            ...
            <div className="flex flex-col items-center space-y-6 max-w-3xl mx-auto">
              <div className="space-y-5 flex flex-col items-center">
                <div className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/5 px-3 py-1 text-xs font-medium text-primary shadow-sm">
              ...
              <div className="flex flex-col gap-6 items-center w-full">
                <div className="flex flex-col sm:flex-row gap-4 justify-center w-full sm:w-auto">
                  <Link href="/signup">
                    <Button size="lg" className="h-11 px-8 rounded-lg text-base font-medium w-full sm:w-auto">
                      Start free trial
                    </Button>
                  </Link>
                  <Link href="#demo">
                    <Button variant="outline" size="lg" className="h-11 px-8 rounded-lg text-base font-medium w-full sm:w-auto bg-transparent border-border/60 hover:bg-secondary/20">
                      Learn more
                    </Button>
                  </Link>
                </div>
        ...
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start">
            <div className="md:w-1/3">
              ...
              <div className="h-1 w-16 bg-primary/20 mt-4 rounded-full" />
            </div>
            <div className="md:w-2/3 grid gap-6 text-base text-muted-foreground leading-relaxed">
              ...
              <div className="grid sm:grid-cols-2 gap-4 text-sm text-foreground font-medium">
      ...
      <section className="w-full py-12 md:py-16 bg-background border-b border-border/40">
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col gap-12 md:gap-24">
            {[
              ...
              <div key={idx} className={`flex flex-col md:flex-row gap-12 lg:gap-20 items-center ${idx % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
      ...
      <section className="w-full py-12 md:py-20 bg-background border-b border-border/40">
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          <div className="flex flex-col items-center text-center mb-12">
            <h2 className="text-3xl font-semibold tracking-tight mb-3">Quick walkthroughs</h2>
            <p className="text-muted-foreground text-base">See how common workflows happen in seconds.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div key={idx} className="group rounded-lg border bg-card overflow-hidden hover:shadow-lg hover:border-primary/20 transition-all cursor-pointer">
                ...
                <div className="p-5">
                  <h3 className="font-semibold text-lg mb-2 group-hover:text-primary transition-colors">{video.title}</h3>
      ...
      <section className="w-full py-12 md:py-20 bg-background border-t border-border/40">
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 relative">
            ...
            {/* Traditional Tools */}
            <div className="space-y-8 p-8 rounded-2xl bg-secondary/5 border border-transparent">
              <div className="flex items-center gap-3 mb-6 opacity-70">
                <div className="p-2 rounded-lg bg-secondary/20">
                  <Minus className="w-5 h-5 text-muted-foreground" />
                </div>
                <h3 className="text-lg font-semibold text-muted-foreground tracking-wide">Traditional Tools</h3>
              </div>
              <ul className="space-y-6">
                {[
                  ...
                  <li key={i} className="flex items-start gap-4 text-muted-foreground group">
                    <X className="w-5 h-5 text-muted-foreground/40 mt-0.5 shrink-0 group-hover:text-red-400/60 transition-colors" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            {/* Wytis */}
            <div className="space-y-8 p-8 rounded-2xl bg-background border border-primary/20 shadow-xl shadow-primary/5 relative overflow-hidden">
              <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-primary/50 to-transparent" />
              <div className="flex items-center gap-3 mb-6">
                <div className="relative w-9 h-9 rounded-lg overflow-hidden">
                  <Image src="/logo.png" alt="Wytis Logo" fill className="object-contain" />
                </div>
                <h3 className="text-lg font-semibold text-foreground tracking-wide">Wytis Operating System</h3>
              </div>
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 text-foreground font-medium">
                    <div className="w-5 h-5 flex items-center justify-center mt-0.5 shrink-0 text-primary">
      ...
      < section className="w-full py-12 md:py-20 bg-background border-t border-border/40" >
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl font-semibold tracking-tight text-foreground mb-5">
              From fragmented data to clear decisions.
            </h2>
            <div className="text-lg text-muted-foreground leading-relaxed font-light max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-transparent bg-secondary/5 hover:border-border/60 transition-colors">
              <div className="w-12 h-12 flex items-center justify-center mb-2">
                <AbstractIntegration className="w-10 h-10 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">One shared reality</h3>
            ...
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-transparent bg-secondary/5 hover:border-border/60 transition-colors">
              <div className="w-12 h-12 flex items-center justify-start mb-2">
                <AbstractQuery className="w-10 h-10 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">Ask in plain English</h3>
              <p className="text-muted-foreground leading-relaxed text-lg">
            ...
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-transparent bg-secondary/5 hover:border-border/60 transition-colors">
              <div className="w-12 h-12 flex items-center justify-start mb-2">
                <AbstractAudit className="w-10 h-10 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">Always audit-ready</h3>
              <p className="text-muted-foreground leading-relaxed text-lg">
            ...
            <div className="flex flex-col gap-4 p-8 rounded-2xl border border-transparent bg-secondary/5 hover:border-border/60 transition-colors">
              <div className="w-12 h-12 flex items-center justify-start pl-1 mb-2">
                <AbstractPulse className="w-10 h-10 text-primary" />
              </div>
              <h3 className="text-xl font-semibold text-foreground">Live financial health</h3>
              <p className="text-muted-foreground leading-relaxed text-lg">
      ...
      {/* 7. PRICING */}
      < section id="pricing" className="w-full py-12 md:py-20 bg-secondary/20 border-t border-border/40" >
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
            ...
            <div className="flex flex-col items-start text-left space-y-3">
              <div className="p-2.5 rounded-lg bg-background border border-border/60 shadow-sm mb-1">
                <CreditCard className="w-5 h-5 text-primary" />
              </div>
              <h3 className="font-semibold text-foreground">No Transaction Fees</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">We don't charge a percentage of your revenue. You keep what you earn.</p>
            </div>
            ...
            <div className="flex flex-col items-start text-left space-y-3">
              ...
              <h3 className="font-semibold text-foreground">Predictable Scaling</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Flat usage tiers that grow with you, not against you.</p>
            </div>
            ...
            <div className="flex flex-col items-start text-left space-y-3">
              ...
              <h3 className="font-semibold text-foreground">All Core Features</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Inventory, Billing, and GST are included in every plan standard.</p>
            </div>
            ...
            <div className="flex flex-col items-start text-left space-y-3">
              ...
              <h3 className="font-semibold text-foreground">Local Context</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">Unlimited E-Invoices and GSTR reports included at no extra cost.</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {/* STARTER */}
            <div className="flex flex-col p-8 rounded-2xl bg-background border border-border/60 hover:border-primary/20 transition-all shadow-sm">
              <h3 className="text-2xl font-semibold text-foreground mb-2">Starter</h3>
              <p className="text-sm text-muted-foreground mb-8">For small teams getting started.</p>
              <div className="mb-8">
                <div className="flex items-baseline">
                  <span className="text-4xl font-bold text-foreground tracking-tight">₹999</span>
              ...
              <Button variant="outline" className="w-full h-11 text-base font-medium border-border/60 bg-transparent hover:bg-secondary/20">Select Starter</Button>
            </div>

            {/* GROWTH */}
            <div className="flex flex-col p-8 rounded-2xl bg-background border-2 border-primary/10 shadow-lg relative transform md:-translate-y-4 z-10">
              <div className="absolute top-0 right-0 -mt-3 -mr-3">
                <span className="bg-primary text-primary-foreground text-xs font-bold px-3 py-1 rounded-full shadow-sm">POPULAR</span>
              </div>
              <h3 className="text-2xl font-semibold text-foreground mb-2">Growth</h3>
              <p className="text-sm text-muted-foreground mb-8">For scaling operations.</p>
              <div className="mb-8">
                <div className="flex items-baseline">
                  <span className="text-4xl font-bold text-foreground tracking-tight">₹2,499</span>
                  <span className="text-muted-foreground ml-2 font-medium">/ month</span>
                </div>
              </div>
              <ul className="space-y-4 mb-8 flex-1">
              ...
              <Button className="w-full h-11 text-base font-medium shadow-md">Select Growth</Button>
            </div>

            {/* SCALE */}
            <div className="flex flex-col p-8 rounded-2xl bg-background border border-border/60 hover:border-primary/20 transition-all shadow-sm">
              <h3 className="text-2xl font-semibold text-foreground mb-2">Scale</h3>
              <p className="text-sm text-muted-foreground mb-8">For complex workflows.</p>
              <div className="mb-8">
                <div className="flex items-baseline">
                  <span className="text-4xl font-bold text-foreground tracking-tight">₹5,999</span>
                  <span className="text-muted-foreground ml-2 font-medium">/ month</span>
                </div>
              </div>
              <ul className="space-y-4 mb-8 flex-1">
              ...
              <Button variant="outline" className="w-full h-11 text-base font-medium border-border/60 bg-transparent hover:bg-secondary/20">Select Scale</Button>
            </div>
          </div>
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {[
                ...
                <AccordionItem key={i} value={`item-${i}`} className="border-b border-border/60 px-1">
                  <AccordionTrigger className="text-left text-base font-medium text-foreground py-6 hover:no-underline hover:text-primary transition-colors">
                    {item.q}
                  </AccordionTrigger>
      ...
      <section className="w-full py-12 md:py-20 bg-background border-t border-border/40">
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 text-sm leading-relaxed text-muted-foreground">

            {/* 1. Your Data - Protected Block */}
            <div className="p-5 -ml-5 rounded-xl hover:bg-secondary/5 transition-colors duration-300">
              <div className="w-10 h-10 flex items-center justify-start mb-3">
                <Database className="w-6 h-6 text-primary" />
              </div>
              <strong className="block text-foreground mb-1.5 text-base font-medium">Your Data is Yours</strong>
              <p>You own your financial data completely. Export it at any time in standard formats. We do not sell or anonymize your data for third parties.</p>
            </div>

            {/* 2. Security - Lock Layer */}
            <div className="p-5 -ml-5 md:ml-0 rounded-xl hover:bg-secondary/5 transition-colors duration-300">
              <div className="w-10 h-10 flex items-center justify-start mb-3">
                <LockIcon className="w-6 h-6 text-primary" />
              </div>
              <strong className="block text-foreground mb-1.5 text-base font-medium">Bank-Grade Security</strong>
              <p>All data is encrypted at rest (AES-256) and in transit (TLS 1.3). We utilize enterprise-grade infrastructure with automated daily backups.</p>
            </div>
            ...
            <div className="p-5 -ml-5 md:ml-0 rounded-xl hover:bg-secondary/5 transition-colors duration-300">
              ...
              <strong className="block text-foreground mb-1.5 text-base font-medium">Reliable & Compliant</strong>
              <p>Designed for high availability with 99.9% uptime SLA. Audit logs track every critical action for full accountability.</p>
            </div>
      ...
      < section className="w-full py-16 md:py-24 bg-background border-t border-border/40" >
        <div className="w-full max-w-[1280px] mx-auto px-4 md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {/* 1. Data Import */}
            <div className="group flex flex-col items-start p-6 rounded-xl bg-background border border-border/40 hover:border-primary/20 hover:bg-secondary/5 transition-all duration-300">
              <div className="w-8 h-px bg-primary/30 mb-6 group-hover:w-12 transition-all duration-500" />
              <h3 className="text-xl font-semibold text-foreground mb-3 tracking-tight">One-Click Import</h3>
              <p className="text-base text-muted-foreground leading-relaxed">
                Upload your existing Excel sheets. We map everything automatically.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-start p-6 rounded-xl bg-background border border-border/40 hover:border-primary/20 hover:bg-secondary/5 transition-all duration-300">
              <div className="w-8 h-px bg-primary/30 mb-6 group-hover:w-12 transition-all duration-500" />
              <h3 className="text-xl font-semibold text-foreground mb-3 tracking-tight">Smart Templates</h3>
              <p className="text-base text-muted-foreground leading-relaxed">
                Pre-built structures for inventory, balances, and customers.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-start p-6 rounded-xl bg-background border border-border/40 hover:border-primary/20 hover:bg-secondary/5 transition-all duration-300">
              <div className="w-8 h-px bg-primary/30 mb-6 group-hover:w-12 transition-all duration-500" />
              <h3 className="text-xl font-semibold text-foreground mb-3 tracking-tight">Zero Errors</h3>
              <p className="text-base text-muted-foreground leading-relaxed">
                Our AI validates your data for accuracy before it ever goes live.
              </p>
            </div>
            ...
            <div className="group flex flex-col items-start p-6 rounded-xl bg-background border border-border/40 hover:border-primary/20 hover:bg-secondary/5 transition-all duration-300">
              <div className="w-8 h-px bg-primary/30 mb-6 group-hover:w-12 transition-all duration-500" />
              <h3 className="text-xl font-semibold text-foreground mb-3 tracking-tight">No Downtime</h3>
              <p className="text-base text-muted-foreground leading-relaxed">
                Keep running your business while we switch you over in the background.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* 11. PRE-FOOTER CTA */}
      < section className="w-full py-16 md:py-20 bg-background border-t border-border/40" >
        <div className="w-full max-w-[800px] mx-auto px-4 md:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <Link href="/signup">
              <Button className="w-full sm:w-auto h-11 px-8 text-base shadow-sm">Start free trial</Button>
            </Link>
            <Link href="/demo">
              <Button variant="outline" className="w-full sm:w-auto h-11 px-8 text-base bg-transparent border-border/60 hover:bg-secondary/20">Learn more</Button>
            </Link>
          </div>
