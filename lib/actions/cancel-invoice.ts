...
/**
 * Cancel/Void an invoice by changing status to 'cancelled'
 * Database trigger automatically creates reversing ledger entries
 * This maintains the audit trail and keeps the ledger immutable
 */
export async function cancelInvoice(invoiceId: string, reason?: string) {
    ...
    // Get business_id and role from user's active membership
